...
var grammar = {
    ...
    {"name": "comparisonOperator", "symbols": [(lexer.has("comparisonOperator") ? {type: "comparisonOperator"} : comparisonOperator)], "postprocess": function(d) { return d[0].value }},
    ...
    {"name": "N$subexpression$1$ebnf$1$subexpression$1", "symbols": ["N$subexpression$1$ebnf$1$subexpression$1$ebnf$1", (lexer.has("dfParamsName") ? {type: "dfParamsName"} : dfParamsName), (lexer.has("comparisonOperator") ? {type: "comparisonOperator"} : comparisonOperator), "N$subexpression$1$ebnf$1$subexpression$1$subexpression$1"]},
    ...
    {"name": "N$subexpression$2$ebnf$1$subexpression$1", "symbols": ["N$subexpression$2$ebnf$1$subexpression$1$ebnf$1", (lexer.has("ioParamsName") ? {type: "ioParamsName"} : ioParamsName), (lexer.has("comparisonOperator") ? {type: "comparisonOperator"} : comparisonOperator), "N$subexpression$2$ebnf$1$subexpression$1$subexpression$1"]},
