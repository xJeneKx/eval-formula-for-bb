...
var grammar = {
    ...
    {"name": "ternary$subexpression$1", "symbols": ["expr"]},
    {"name": "ternary$subexpression$1", "symbols": ["concat"]},
    {"name": "ternary$subexpression$2", "symbols": ["expr"]},
    {"name": "ternary$subexpression$2", "symbols": ["concat"]},
    {"name": "ternary", "symbols": ["expr", {"literal":"?"}, "ternary$subexpression$1", {"literal":":"}, "ternary$subexpression$2"], "postprocess": function(d) {return ['ternary', d[0], d[2][0], d[4][0]];}},
    {"name": "OR", "symbols": ["comparison2", (lexer.has("or") ? {type: "or"} : or), "expr"], "postprocess": function(d) {return ['or', d[0], d[2]];}},
    {"name": "AND", "symbols": ["comparison2", (lexer.has("and") ? {type: "and"} : and), "expr"], "postprocess": function(d) {return ['and', d[0], d[2]];}},
    ...
    {"name": "concat", "symbols": ["AS"], "postprocess": id},
    {"name": "concat", "symbols": [(lexer.has("string") ? {type: "string"} : string)], "postprocess": id},
    {"name": "expr", "symbols": ["AS", "comparisonOperator", "AS"], "postprocess": function(d) {return ['comparison', d[1], d[0], d[2]];}},
    {"name": "expr", "symbols": ["concat"], "postprocess": id},
    {"name": "expr", "symbols": ["string", "comparisonOperator", "string"], "postprocess": function(d) {return ['stringComparison', d[1], d[0], d[2]];}},
    {"name": "expr", "symbols": ["AS", "comparisonOperator", "string"], "postprocess": function(d) {return ['stringComparison', d[1], d[0], d[2]];}},
    {"name": "expr", "symbols": ["string", "comparisonOperator", "AS"], "postprocess": function(d) {return ['stringComparison', d[1], d[0], d[2]];}},
